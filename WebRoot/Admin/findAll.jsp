								...
								<!-- s:iterator绑定数据 -->
									<s:iterator value="#request.pageBean.list" id="item">
										<tr>								
											...
											<label><button class="btn btn-info btn-sm glyphicon glyphicon-search queryBtn">查看或修改</button>
											</label>&nbsp;&nbsp;&nbsp;&nbsp;<span>
											<button class="btn btn-info btn-sm glyphicon glyphicon-file AddfileBtn">添加附件</button>
											</span>&nbsp;&nbsp;&nbsp;
											<span>
											<button class="btn btn-info btn-sm glyphicon glyphicon-file QueryfileBtn">查看附件</button>
											</span>&nbsp;&nbsp;&nbsp;<span>
											<button class="btn btn-info btn-sm glyphicon glyphicon-remove deleteBtn">删除</button>
											</span></td>
										</tr>
									</s:iterator>
								</tbody>
