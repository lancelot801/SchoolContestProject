...
<body>
								...
								<tbody id="datalist">
									...
									<s:iterator value="#request.pageBean.list" id="item">
										<tr>
											...
											<td class="text-center"><label><button
														class="btn btn-info btn-sm glyphicon glyphicon-search queryBtn">查看或修改</button>
											</label>&nbsp;&nbsp;&nbsp;&nbsp;<span>
													<button
														class="btn btn-info btn-sm glyphicon glyphicon-arrow-up AddfileBtn">添加附件</button>
											</span>&nbsp;&nbsp;&nbsp; <span>
													<button
														class="btn btn-info btn-sm glyphicon glyphicon-file QueryfileBtn">查看附件</button>
											</span> &nbsp;&nbsp;&nbsp; <span>
													<button
														class="btn btn-info btn-sm glyphicon glyphicon-pencil ScoreDetailBtn">评分标准</button>
											</span></td>
										</tr>
									</s:iterator>
								</tbody>
	...
	<!-- 分页 -->
	<!-- 模态框） -->
	<div class="modal fade" id="dialog2" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">添加评分细则</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal bv-form">
						<div class="form-group ">
							...
							<div class="col-xs-4">
								<input class="form-control" id="aspectConId2" readonly="readonly" />
							</div>
						</div>
					
						<div class="form-group ">
							<label class="col-xs-4  control-label"> 评分细则： </label>
							<div id="player" class="col-xs-4"   >	
								<input class="form-control"   placeholder="编号"/>
							</div>
							<div class="col-xs-1 ">
								<a id="add2" class="btn glyphicon glyphicon-plus"></a>
							</div>
						</div>
					</form>
				</div>
			...
			<!-- 评分标准模态框 -->
			<div class="modal  fade" id="markDetailsModel">
		<div class="modal-dialog">
			<form id="markDetails" action="addMarkList" method="post">
				<div class="modal-content">
					<div class="modal-header">
						<button class="close" data-dismiss="modal" type="button">&times;</button>
						<h4 class="modal-title">
							<span class="glyphicon glyphicon-leaf"></span>&nbsp;评分标准
						</h4>
					</div>
					<div class="modal-body">
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="form-group">
									<label  class="col-sm-2 control-label mylabStyle">竞赛编号</label>
									<div class="col-sm-7">
										<input type="text" id="aspectConId" name="aspectConId" readonly="readonly"
											class="form-control" />
									</div></div>
								<br /> <br />
								
									<div class="form-group" >
									<label   class="col-sm-2 control-label mylabStyle">评分细则</label>
									<div id="markplayer">
									<div class="row" >
											<div class="col-sm-2">
										<input class="form-control"   readonly="readonly"  id="aspectId" name="markList[0].aspectId" value="1" />
															
											</div>
											<div class="col-sm-4">
								<!--  		<input class="form-control"  id=“aspect” name="markList[0].aspect"  placeholder="类别"/>  -->
											...
											<div class="col-sm-2">
											<input class="form-control"  id="score" name="markList[0].score"  placeholder="分数"/>
											</div>
												<div class="col-sm-1 ">
										<a id="add" class="btn glyphicon glyphicon-plus"></a></div>
								</div>
					...
					<div class="modal-footer">
						<button type="button" id="btnClose" class="btn btn-default"
							data-dismiss="modal">关闭</button>
						<button type="submit" class="btn btn-primary" id="submitMarkBtn">提交</button>
					</div>
				</div>
				</div>
				</div>
