  ...
  <body>
	...
	<div class="modal  fade" id="myPickingModal">
		<div class="modal-dialog">
			<form id="myPicking"
				action="${pageContext.request.contextPath}/addContestMessage"
				method="post">
					...
					<div class="modal-body">
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<br /> <br /> <br /> <br /> <br/>
								<div class="form-group">
									<label for="picker" class="col-sm-2 control-label mylabStyle">指导老师</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="jurorLeader"
											name="jurorLeader" placeholder="指导老师" />
									</div>
								</div>
								<br /> <br />
											<div class="form-group">
