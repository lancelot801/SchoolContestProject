			...
			<div class="col-md-10">
				...
				<div class="panel panel-default">
					<div class="panel-body" >
						<iframe src="" width="100%" height="100%" border="none"
					...
					<div class="modal-body">
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control " id="grade"
											name="grade">
											<option value="">--请选择每组人数--</option>
											<option value="1">单人赛</option> 
											<option value="2">双人赛</option> 
											<option value="3">三人赛</option> 
											<option value="4">四人及四人以上赛</option> 							
										</select>
									</div>
								</div>
								<br /> <br />
								...
								<br /> <br />
								<div class="form-group">
									<label for="pickPhone" class="col-sm-2 control-label mylabStyle">负责教师</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="teaId"
											name="teaId" placeholder="输入负责教师" />
									</div>
								</div>
								<br /> <br />
									<div class="form-group">
